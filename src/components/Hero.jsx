...
const HERO_ORBIT_SERVICES = [
  {
    ...
    inactiveBadge: 'bg-violet-100 text-violet-700 border border-violet-200',
    activeCard: 'border-violet-500 ring-4 ring-violet-500/15 shadow-luxury scale-105 z-40',
  },
  {
    id: 'product-dev',
    ...
    inactiveBadge: 'bg-orange-100 text-orange-700 border border-orange-200',
    activeCard: 'border-orange-500 ring-4 ring-orange-500/15 shadow-luxury scale-105 z-40',
  },
  {
    id: 'on-demand',
    ...
    inactiveBadge: 'bg-emerald-100 text-emerald-700 border border-emerald-200',
    activeCard: 'border-emerald-500 ring-4 ring-emerald-500/15 shadow-luxury scale-105 z-40',
  },
  {
    id: 'cloud-devops',
    title: 'Cloud & DevOps',
    ...
    inactiveBadge: 'bg-sky-100 text-sky-700 border border-sky-200',
    activeCard: 'border-[#0284C7] ring-4 ring-[#0284C7]/15 shadow-luxury scale-105 z-40',
  },
  {
    id: 'dedicated-teams',
    ...
    inactiveBadge: 'bg-indigo-100 text-indigo-700 border border-indigo-200',
    activeCard: 'border-indigo-500 ring-4 ring-indigo-500/15 shadow-luxury scale-105 z-40',
  },
  {
    id: 'consulting',
    title: 'Consulting',
    ...
    inactiveBadge: 'bg-teal-100 text-teal-700 border border-teal-200',
    activeCard: 'border-teal-500 ring-4 ring-teal-500/15 shadow-luxury scale-105 z-40',
  },
];
