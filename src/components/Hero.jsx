...
const HERO_ORBIT_SERVICES = [
  {
    ...
    activeBadge: 'bg-purple-600 text-white shadow-sm shadow-purple-500/30',
    inactiveBadge: 'bg-purple-600/90 text-white shadow-sm',
    activeCard: 'border-purple-500 ring-4 ring-purple-500/20 shadow-luxury scale-105 z-40',
  },
  {
    id: 'product-dev',
    ...
    activeBadge: 'bg-sky-500 text-white shadow-sm shadow-sky-500/30',
    inactiveBadge: 'bg-sky-500/90 text-white shadow-sm',
    activeCard: 'border-sky-500 ring-4 ring-sky-500/20 shadow-luxury scale-105 z-40',
  },
  {
    id: 'on-demand',
    ...
    inactiveBadge: 'bg-indigo-600/90 text-white shadow-sm',
    activeCard: 'border-indigo-500 ring-4 ring-indigo-500/20 shadow-luxury scale-105 z-40',
  },
  {
    id: 'cloud-devops',
    title: 'Cloud & DevOps',
    ...
    inactiveBadge: 'bg-blue-600/90 text-white shadow-sm',
    activeCard: 'border-blue-500 ring-4 ring-blue-500/20 shadow-luxury scale-105 z-40',
  },
  {
    id: 'dedicated-teams',
    ...
    activeBadge: 'bg-emerald-500 text-white shadow-sm shadow-emerald-500/30',
    inactiveBadge: 'bg-emerald-500/90 text-white shadow-sm',
    activeCard: 'border-emerald-500 ring-4 ring-emerald-500/20 shadow-luxury scale-105 z-40',
  },
  {
    id: 'consulting',
    title: 'IT Consulting',
    ...
    activeBadge: 'bg-amber-500 text-white shadow-sm shadow-amber-500/30',
    inactiveBadge: 'bg-amber-500/90 text-white shadow-sm',
    activeCard: 'border-amber-500 ring-4 ring-amber-500/20 shadow-luxury scale-105 z-40',
  },
];
