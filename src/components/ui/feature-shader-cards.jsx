...
export default function FeaturesCards() {
  ...
  return (
    <section className="py-20 px-4 bg-[#FAFCFF] border-b border-[#D0E2F7]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-extrabold text-[#0B2545] mb-4">
            Powerful Visual Features
          </h2>
          <p className="text-base sm:text-lg text-[#475569] max-w-3xl mx-auto leading-relaxed font-sans">
            Everything you need to create stunning visual experiences with elegant WebGL shader backgrounds
          </p>
        </div>
          ...
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className="relative h-80">
                ...
                <div className="relative z-10 p-8 rounded-3xl h-full flex flex-col bg-[#0B2545]/85 backdrop-blur-md border border-white/20">
                  ...
                  <p className="leading-relaxed flex-grow text-gray-200 text-sm font-medium font-sans">{feature.description}</p>

                  <div className="mt-6 flex items-center text-sm font-bold text-sky-300 group cursor-pointer hover:text-white transition-colors">
